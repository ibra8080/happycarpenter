...
class Advertisement(models.Model):
    professional = models.ForeignKey(User, on_delete=models.CASCADE, related_name='advertisements')
...
class JobOffer(models.Model):
    ...
    professional = models.ForeignKey(User, on_delete=models.CASCADE, related_name='job_offers')
    client = models.ForeignKey(User, on_delete=models.CASCADE, related_name='job_offers_made')
    title = models.CharField(max_length=200)
    description = models.TextField()
